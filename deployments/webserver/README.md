...
Module `sdkwork-assets` · runtime code `assets` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `assets-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `assets-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `assets-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `assets-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `assets.sdkwork.com` | 443 ssl + 80 |
