# Runbook — sdkwork-assets deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-assets-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-assets/bundle`, loads the image, starts
